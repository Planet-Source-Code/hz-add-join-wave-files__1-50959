...
Begin VB.Form frmMain 
   ...
   Begin VB.CommandButton Command2 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Open Text To Speech Window"
      Height          =   495
      Left            =   9360
      Style           =   1  'Graphical
      TabIndex        =   35
   ...
   Begin VB.CommandButton cmdOpen 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Open Wave File To join"
      Height          =   495
      Left            =   720
      Style           =   1  'Graphical
      TabIndex        =   34
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdMakeNewFile 
         BackColor       =   &H00E0E0E0&
         Caption         =   "Join Files"
         DisabledPicture =   "frmJoin.frx":3E84
         Height          =   1095
         Left            =   2760
         Picture         =   "frmJoin.frx":7306
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   840
         Width           =   1215
   ...
   Begin VB.Label Label5 
      Caption         =   "This code is only work for mono files. if u want to join stereo wave files , look at the code and add to both channels"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   177
